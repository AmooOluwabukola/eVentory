...
(function () {
  ...
  function decorateTools() {
    ...
    // Jumps straight to the Orders page with the Record Sale tab open
    // (orders.js reads ?tab= on load and clicks the matching .orders-tab).
    if (newOrderBtn) {
      newOrderBtn.addEventListener("click", () => {
        window.location.href = "orders.html?tab=record";
      });
    }
  }
